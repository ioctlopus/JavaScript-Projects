...
function placeXOrO(squareNumber){
    ...
    if(!selectedSquares.some(element => element.includes(squareNumber))){
        ...
        //This condition checks to see if it is compputer's turn.
        if(activePlayer === 'O'){
    ...
    function computersTurn(){
        ...
        let pickASquare;
        //This consition allows our while loop to keep trying if a square is selected already.
        while(!success){
...
function checkWinConditions(){
    ...
    function arrayIncludes(squareA, squareB, squareC){
        ...
        //returned and our else if consition executes the drawWinLine function.
...
//This function resets the game in the event of a tie or  awin.
function resetGame(){
